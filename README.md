...
Vim is Free Software.  You can use and copy it as much as you like, but you are
encouraged to make a donation to yourself.  Please read the file
[`runtime/doc/uganda.txt`](./runtime/doc/uganda.txt)
for details (do `:help uganda` inside Vim).

For modified versions, a few restrictions apply.
